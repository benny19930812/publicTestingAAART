			...
			<table class="table table-bordered">
				...
				<c:forEach items="${sessionScope.shoppingcart.seats}" var="seat">
					...
					<tr>
						...
						<td class="price"></td>
						<td>
		<form name="order" id="form${seat}"
							action="<c:url value='/04/delectTicket.ctrl'/> "
							<input type="hidden" id="seat" name="seat" value="${seat}">
						<button type="button" class="genric-btn success-border radius"  onclick="delticket()">刪除</button>
		</form>
						</td>
					</tr>
				</c:forEach>
...
// 		}
		...
		$(".genric-btn success-border radius").click(function(){
		function delticket() {
